    ...
    <div className="space-y-33 pt-38 pb-86">
      <main className="narrow-container">
        <div className="space-y-4">
          ...
          <p className="-tracking-[0.02em] text-15/7 text-nobel-100">
            One of the key projects I directed was Paydoo’s full rebranding into Paynt — redefining
            the brand’s identity, visual language, and communication style to better reflect its
